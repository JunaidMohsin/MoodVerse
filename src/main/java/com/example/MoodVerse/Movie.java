...
public class Movie {
    ...
    public String getApi_Genre() {
        return api_Genre;
    }

    public void setApi_Genre(String api_Genre) {
        this.api_Genre = api_Genre;
    }
    ...
    public Movie(String title, Date year, String omdb_Id, String poster_path, String description, Float popularity, String mood, String api_Genre) {
        this.title = title;
        this.year = year;
        Omdb_Id = omdb_Id;
        Poster_path = poster_path;
